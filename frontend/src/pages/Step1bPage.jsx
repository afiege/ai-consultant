...
import { maturityAPI } from '../services/api';
...
const MaturitySlider = ({ value, onChange, questionKey, dimensionKey, t }) => {
  const levelName = MATURITY_LEVELS.find(l => l.level === Math.round(value))?.key || 'computerization';
...
const Step1bPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <PageHeader
        title={t('step1b.title')}
        subtitle={t('step1b.subtitle')}
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex justify-center mb-8">
          ...
          >
            {saving ? t('common.saving') : saved ? t('step1b.saved') : t('step1b.saveAssessment')}
          </button>
        </div>
